    ...
    <div v-if="isMobile" class="flex mx-auto mt-36 px-12">
      ...
      <div class="flex flex-col mt-2 w-2/3">
        <span
          ...
          :class="largerText ? 'text-8xl' : 'text-7xl'"
          >Hello!</span
        ><span
          class="text-lg my-2 ml-2 mr-6"
          :class="largerText ? 'text-lg' : 'text-sm'"
          >My name is Conner Lusk and I am a fourth year computer science major
          at Northeastern University. I am passionate about researching the
          intersection between technology and healthcare to develop new software
          within this space that maintains privacy and security of the end user.
        </span>
